...
lazy.setup({
  ...
  { "williamboman/mason.nvim", cmd = "Mason", event = { "BufReadPre", "BufNewFile" } },           -- Simple to use language server installer
  ...
  { "tpope/vim-projectionist", event = "VeryLazy" },      -- Configurable projections (like go to test file and back)
  ...
  { "tpope/vim-fugitive", cmd = { "Git", "Gvdiffsplit", "Gread", "Gwrite", "Ggrep", "GMove", "GDelete", "GBrowse", "GRemove", "GRename", "Glgrep", "Gedit" } }, -- Git wrapper
